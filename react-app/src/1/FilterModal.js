      ...
      <div className="modal-dialog modal-dialog-centered" role="document">
        ...
        <div className="modal-content">
          ...
          <div className="modal-header">
            ...
            <h3 className="modal-title" id="filter-heading">
              Filters
            </h3>
            ...
            <div>
              ...
              <button
                className={
                  ...
                  (props.currentFilter.gender === "none"
                    ? " btn-active"
                    : "")
                }
                onClick={() => props.updateFilter("none")}
              >
                No Filter
              </button>
              ...
              <button
                className={
                  "btn btn-outline-dark" +
                  (props.currentFilter.gender === "unisex"
                    ? " btn-active"
                    : "")
                }
              ...
              <button
                className={
                  "btn btn-outline-dark" +
                  (props.currentFilter.gender === "male"
                    ? " btn-active"
                    : "")
                }
              ...
              <button
                className={
                  "btn btn-outline-dark" +
                  (props.currentFilter.gender === "female"
                    ? " btn-active"
                    : "")
                }
